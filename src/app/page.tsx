  ...
  const dynamicCategoryBlocks = await Promise.all(
    homepageRowsConfig.map(async (row, index) => {
       ...
       if (products.length === 0) {
         products = [
           { id: `mock-${row.id}-1`, sku: `mock-${row.id}-1`, name: `Sản phẩm mẫu 1 - ${row.title}`, price: 150000, originalPrice: 200000, discount: 25, stock: 10, images: ["https://vcdn.tikicdn.com/cache/w1200/ts/product/f3/d3/42/411eb345d14df9042bbf062dc7ed8eb7.png"], category: row.categorySlug, specs: {} },
           { id: `mock-${row.id}-2`, sku: `mock-${row.id}-2`, name: `Sản phẩm mẫu 2 - ${row.title}`, price: 250000, originalPrice: 300000, discount: 15, stock: 10, images: ["https://vcdn.tikicdn.com/cache/w1200/ts/product/4c/bb/56/674d812bd1bd5bdfb60fcd82fdf63d50.jpg"], category: row.categorySlug, specs: {} },
           { id: `mock-${row.id}-3`, sku: `mock-${row.id}-3`, name: `Sản phẩm mẫu 3 - ${row.title}`, price: 350000, originalPrice: 400000, discount: 12, stock: 10, images: ["https://vcdn.tikicdn.com/cache/w1200/ts/product/1c/a7/9c/04b50e50efb0e352efdfafba760317e0.png"], category: row.categorySlug, specs: {} },
           { id: `mock-${row.id}-4`, sku: `mock-${row.id}-4`, name: `Sản phẩm mẫu 4 - ${row.title}`, price: 450000, originalPrice: 500000, discount: 10, stock: 10, images: ["https://vcdn.tikicdn.com/cache/w1200/ts/product/a6/50/66/f28782a2b72cfdb8421b1a50c8e03e5c.png"], category: row.categorySlug, specs: {} },
           { id: `mock-${row.id}-5`, sku: `mock-${row.id}-5`, name: `Sản phẩm mẫu 5 - ${row.title}`, price: 550000, originalPrice: 600000, discount: 8, stock: 10, images: ["https://vcdn.tikicdn.com/cache/w1200/ts/product/e5/26/66/1d13db9b581d4a04fc9a918a599b4d00.png"], category: row.categorySlug, specs: {} },
           { id: `mock-${row.id}-6`, sku: `mock-${row.id}-6`, name: `Sản phẩm mẫu 6 - ${row.title}`, price: 650000, originalPrice: 700000, discount: 7, stock: 10, images: ["https://vcdn.tikicdn.com/cache/w1200/ts/product/6e/b5/1d/18e38eaed7fb8c9f5926715b7468132e.png"], category: row.categorySlug, specs: {} },
         ];
       }
